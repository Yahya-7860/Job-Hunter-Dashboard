...
const ResumeTips = () => {
  return (
    <div className="flex justify-center">
      <div className="bg-white dark:bg-neutral-900 text-gray-800 dark:text-gray-100 p-6 sm:p-10 rounded-2xl shadow-lg max-w-4xl mx-2 my-10 border border-gray-400 ">
        ...
        <section className="mb-8">
          ...
          <ul className="list-decimal list-inside space-y-3">
            <li>
              <strong>Career Objective:</strong> A short 2–3 line statement
              about your career goal and how you can add value.
            </li>
            <li>
              <strong>Educational Details:</strong> Mention degrees,
              institutions, CGPA/percentage, and year of passing.
            </li>
            <li>
            ...
            <li>
              <strong>Academic/Personal Projects:</strong> Add 1–2 strong
              projects with your role, tech stack, and impact.
            </li>
            <li>
            ...
            <li>
              <strong>Achievements (Optional):</strong> Include any
              recognitions, competitions, etc.
            </li>
            <li>
